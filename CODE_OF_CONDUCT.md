...
* Sharing real iMessage data or conversation content without consent
...
* **Never** share real message content in issues, PRs, or discussions
* **Always** use synthetic/fake data in examples
* **Respect** the privacy-first design principles
* **Report** any accidental exposure of real data immediately
